...
- Replaced deprecated Chrome install (apt-key) with browser-actions/setup-chrome@c785b87e244131f27c9f19c1a33e2ead956ab7ce (v1).
- Added least-privilege workflow permissions to `test.yml` (`contents: read`).
